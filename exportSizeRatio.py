...
for prefix in ("10a", "30a", "50a", "100a"):
    for postfix in ("30cm_masked", "60cm_masked"):
        hotspot_ids_np = gdal.Open("data/processed/" + prefix + "_hotspot_ids_" + postfix + ".tif")
        subcatchments_np = gdal.Open("data/processed/" + prefix + "_subcatchments_" + postfix + ".tif")

        ids_hs, freq_hs = np.unique(hotspot_ids_np.GetRasterBand(1).ReadAsArray(), return_counts=True)
        ...
        df.to_csv("data/processed/" + prefix + "_hotspot_size_ratio_" + postfix + ".csv")
